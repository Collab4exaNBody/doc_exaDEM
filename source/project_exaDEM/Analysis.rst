...
Note both options are used by default when you include the `config_polyhedra.msp file`. In addition, paraview does not include the layer of shape->radius size.
